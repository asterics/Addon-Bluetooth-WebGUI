            ...
            if (value == 'AT') {
                ...
                _invervalHandler = setInterval(function () {
                    if (L.isFunction(_valueHandler)) {
                        ...
                        _valueHandler(`${VALUE_CONSTANT}${thiz.pressure},${getRandomInt(500,600)},${getRandomInt(500,600)},${getRandomInt(500,600)},${getRandomInt(500,600)},${thiz.x},${thiz.y},111,mouse,10,10`);
                    }
                }, 200);
