...
C.AT_CMD_AUDIO_DELETE = 'AT AD';
C.AT_CMD_AUDIO_PLAY   = 'AT AP';


// TBD: handle long press / double press etc, decide if/how to integrate anti-tremor timings ...
C.AT_CMD_THRESHOLD_LONGPRESS = 'AT LP'; 
C.AT_CMD_THRESHOLD_AUTODWELL = 'AT DT';
...
C.AT_CMD_SIP_STRONG_THRESHOLD, C.AT_CMD_ORIENTATION_ANGLE, C.AT_CMD_THRESHOLD_AUTODWELL, C.AT_CMD_SET_COLOR, C.AT_CMD_SENSORBOARD, 
C.AT_CMD_KEYBOARD_LAYOUT, C.AT_CMD_AUDIO_VOLUME];
...
// AT commands, categories and descriptions
